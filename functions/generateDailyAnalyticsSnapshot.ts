...
Deno.serve(async (req) => {
    try {
        ...
        // We'll use service role for analytics calculations to bypass RLS and see all data
        ...
        // Status: Completed, scheduled_date >= 30 days ago (Approximation)
        ...
        // Status NOT: Completed, Lost, Lead, Warranty
        // We assume "In Progress" implies active work stages
        ...
        // 4. Contract Jobs Due
        // Jobs with contract_id set, status Open/Scheduled.
        ...
        // 5. SLA Breaches
        // Jobs where sla_met is explicitly false OR active jobs overdue
        ...
        // Use JobSummary check_in/check_out duration for recent jobs
