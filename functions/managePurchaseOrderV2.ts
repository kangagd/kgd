...
console.log('[managePurchaseOrderV2 INIT] Valid statuses:', Object.values(PO_STATUS));
    ...
    try {
        ...
        if (action === 'create') {
            ...
            if (!po.po_reference) {
                ...
                console.log('[managePurchaseOrderV2] action=create Generated PO Reference:', generatedRef);
            }
            
            console.log('[managePurchaseOrderV2] action=create Created PO:', {
                id: po.id,
        ...
        if (action === 'update') {
            ...
            console.log("[managePurchaseOrderV2] action=update Received:", {
                id,
            ...
            console.log("[managePurchaseOrderV2] action=update Update payload:", {
            ...
            console.log("[managePurchaseOrderV2] action=update DB result:", {
        ...
        if (action === 'updateStatus') {
            ...
            console.log('[managePurchaseOrderV2] action=updateStatus Status validation:', {
                received: status,
            ...
            console.log('[PO updateStatus] pure status update', { id, status: newStatus });
            ...
            if (!normalizedRef) {
                ...
                console.log('[managePurchaseOrderV2] action=updateStatus Generated missing po_reference:', normalizedRef);
            }
            ...
            console.log('[managePurchaseOrderV2] action=updateStatus Preserving identity:', {
                poId: id,
                po_reference: updateData.po_reference,
            ...
            console.log('[managePurchaseOrderV2] action=updateStatus Result:', {
                po_reference: updatedPO.po_reference,
        ...
        if (action === 'getOrCreateProjectSupplierDraft') {
            ...
            if (!newPO.po_reference) {
                ...
                console.log('[managePurchaseOrderV2] action=getOrCreateProjectSupplierDraft Generated PO Reference:', generatedRef);
            }
