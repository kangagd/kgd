...
export default function EditableField({
  ...
  return (
    <div
      onClick={() => setIsEditing(true)} className="bg-[#ffffff] text-slate-950 p-2 text-sm font-bold rounded-lg flex items-center gap-2.5 md:p-3 cursor-pointer hover:bg-slate-100 transition-colors">
