  ...
  return (
    <>
      <Card className={`border-none shadow-lg ${isTechnician ? 'rounded-none' : ''}`}>
        <CardHeader className="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white p-2 md:p-3 space-y-1.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-2 mb-1.5">
                  ...
                  <EditableField
                    ...
                    className="text-sm font-bold bg-purple-50 text-purple-700 border-purple-200" />

                </div>
                
                <div className="flex items-center gap-1 mb-1.5">
                  <MapPin className="text-slate-400 w-3.5 h-3.5 flex-shrink-0" />
                  <span className="text-xs md:text-sm font-medium text-slate-700 truncate">{job.address}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <Button
                    ...
                    className="h-6 px-2 text-xs hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700">
                  ...
                  <Button
                    ...
                    className="h-6 px-2 text-xs hover:bg-green-50 hover:border-green-300 hover:text-green-700">
                  ...
                  <Button
                    ...
                    className="h-6 px-2 text-xs hover:bg-purple-50 hover:border-purple-300 hover:text-purple-700">
