...
import { resolvePartLabel, getPartCachedFields } from "@/components/v2/parts/partLabelResolver";
            ...
            <div className="space-y-2">
              {jobConsumptions.map(cons => (
                <div key={cons.id} className="border rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-medium">{resolvePartLabel(cons, priceListItemMap)}</span>
