...
export default function RestockRequestModal({ open, onClose, vehicle, stock }) {
  ...
  // Filter items below minimum target (includes 0 quantity items that should be restocked)
  const lowStockItems = stock.filter(i => 
    (i.quantity_on_hand || 0) < (i.minimum_target_quantity || 0)
  );
