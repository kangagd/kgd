      ...
      <CardHeader className="border-b border-[#E5E7EB] bg-white p-3 md:p-4 space-y-3">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <EditableField
              value={project.project_status || "Lead"}
              onSave={(val) => handleFieldSave('project_status', project.project_status, val)}
              type="select"
              options={[
              ...
              displayFormat={(val) => (
                <Badge className={`${projectStatusColors[val] || projectStatusColors["Lead"]} font-semibold border-0 px-3 py-1 rounded-lg text-xs`}>
                  {val}
                </Badge>
              )}
            />
                        ...
                        <div className="flex items-start gap-3">
                          <div className="flex-1 min-w-0 space-y-2">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <Badge className={`${jobStatusColors[job.job_status || job.status]} hover:${jobStatusColors[job.job_status || job.status]} border-0 font-semibold text-xs px-3 py-1 rounded-lg`}>
