...
<main
  id="app-scroll"
  className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden pb-6 bg-[#ffffff] relative w-full max-w-full"
  style={{ WebkitOverflowScrolling: "touch" }}
>
  <XeroConnectionBanner />

  {/* PullToRefresh must NOT be a scroll container */}
  <PullToRefresh onRefresh={handleRefresh} scrollContainerId="app-scroll">
    <div className="relative">
      {activeCheckIn && <ActiveCheckInBanner checkIns={activeCheckIn} />}
      {children}
    </div>
  </PullToRefresh>
</main>
