    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Loading Bay (V2)</h1>
        </div>
        <p className="text-gray-600">View receipts, track SLA, and clear inventory</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Loading Bay Dashboard V2 - Coming Soon</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-gray-600">
            <li>All receipts currently in Loading Bay</li>
            <li>Age timers (&lt;24h, 24-48h, &gt;48h 🚨)</li>
            <li>SLA breach warnings</li>
            <li>"Create Run to clear" actions</li>
          </ul>
        </CardContent>
      </Card>
    </div>
