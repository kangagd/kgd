        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden bg-[#F9FAFB] border-r border-[#E5E7EB]">
          {selectedThread ? (
            <>
              ...
              <div className="flex-1 overflow-y-auto min-h-0 flex flex-col">
                {/* Context Panel Toggle for Mobile */}
                <div className="px-4 py-2 border-b border-[#E5E7EB] bg-white xl:hidden">
                  <button
                    onClick={() => setContextOpen(true)}
                    className="text-sm font-medium text-[#6B7280] hover:bg-[#F3F4F6] px-3 py-1.5 rounded transition-colors"
